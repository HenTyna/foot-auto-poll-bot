...
ORDER_INSTRUCTION_TEXT = "ចុចប៊ូតុងខាងក្រោមដើម្បីបញ្ជាទិញ (ប្រើបានតែម្តង)៖"
ORDER_NAME = "Seyha"
...
៣. រង់ចាំការជ្រើសរើសរួចរាល់ រួចចុចប៊ូតុង Order 🛒 (⚠️ប្រើបានតែម្តង)
...
ERROR_ORDER_BUTTON_USED = "ប៊ូតុង Order ត្រូវបានប្រើប្រាស់រួចរាល់ហើយ។"
